...
class IntroWindow(Tk):
    def __init__(self) -> None:
        super().__init__()
        self.title("Pythescape")  # Titre de la fenêtre principale
        ...
        self._start_game_btn = ttk.Button(self, text="Ok", command=self._start)
    ...
    def _start(self) -> None:
        ...
        Rules()()  # Lance la fenêtre Rules indiquant les règles du jeu
